...
<head>
    ...
    <title>QuickBuyStore - Dashboard</title>
        ...
        <div id="wrapper">
            ...
            <nav id="sidebar"
                ...
                <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                        ...
                        <div class="mx-3 sidebar-brand-text">QuickBuyStore</div>
                    </a>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <!-- TopBar -->
                    <nav class="mb-4 navbar navbar-expand navbar-light bg-navbar topbar static-top" id="topbar"
                        v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/forget' ? false : true "
                        style="display: none;">
                ...
                <footer class="bg-white sticky-footer">
                    <div class="container my-auto">
                        <div class="my-auto text-center copyright">
                            ...
                            <b><a href="#" target="_blank">QuickBuyStore</a></b>
                            </span>
                        </div>
                    </div>
                </footer>
